...
<body>
        <form action="list/insert_character.php" method="post">
...
<input type="text" name="platform"> <br>
    ...
    <label for="">game_engine</label>
<input type="text" name="game_engine"> <br>

    <label for="">poster</label>
<input type="text" name="poster_img"> <br>
...
<label for="">chose season</label>
<select name="season_id" id="">
<?php
  foreach($result as $ss){
    ?>
    <option value="<?= $ss["season_id"] ?>">
        <?= $ss["season_id"] ."_". $ss["title"] . " " ?>
    </option>
    <?php
  }
?>
